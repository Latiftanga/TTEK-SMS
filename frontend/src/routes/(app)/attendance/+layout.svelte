...
<style>
  ...
  .tab       { @apply -mb-px flex shrink-0 items-center gap-1.5 whitespace-nowrap border-b-2 border-transparent px-4 py-2 text-sm font-medium text-[var(--fg-muted)] transition hover:text-[var(--fg)]; }
