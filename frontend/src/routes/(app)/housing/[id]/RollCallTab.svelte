      ...
      {:else}
        <div class="grid gap-3 sm:grid-cols-2">
          ...
          <div>
            ...
            <input type="number" min="0" inputmode="numeric" bind:value={rf.expected} placeholder="e.g. 45" class="input" />
          </div>
          <div>
            <label class="label">Students present <span class="text-red-500">*</span></label>
            <input type="number" min="0" inputmode="numeric" bind:value={rf.present} placeholder="e.g. 43" class="input" />
          </div>
          <div class="sm:col-span-2">
