...
from app.routers import academic, academic_structure, assessments, attendance, auth, dashboard, documents, fees, housing, portal, report_cards, schools, sms, staff, students, sync
