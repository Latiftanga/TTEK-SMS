...
from app.routers import academic, academic_structure, ai, assessments, attendance, auth, dashboard, documents, email, fees, housing, portal, report_cards, schools, sms, staff, staff_category, students, sync
