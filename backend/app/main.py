...
from app.routers import academic, academic_structure, ai, assessments, attendance, auth, dashboard, documents, email, fees, housing, permissions, portal, report_cards, schools, sms, staff, staff_category, students, students_detail, students_enrollment, students_lifecycle, sync
